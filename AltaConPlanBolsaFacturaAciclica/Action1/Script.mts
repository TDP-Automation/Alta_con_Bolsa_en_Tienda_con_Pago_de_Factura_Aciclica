...
'				wait 2
				...
				'MsgBox Valor
				'Valor = Left(Valor,21)
				Valor2 = DataTable("e_AcuerdoComercial",dtLocalSheet)
...
Sub TipoEnvio()
	...
	Select Case str_metodo_entrega
		...
		Case "Delivery"
				...
				wait 1
				JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar dirección de_2").JavaEdit("TextFieldNative$1").Set "72512373"
				wait 1
